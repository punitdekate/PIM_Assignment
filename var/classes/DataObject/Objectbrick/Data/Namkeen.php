...
/**
* Get Snacktype - SnackType
* @return string|null
*/
public function getSnacktype(): ?string
{
	$data = $this->Snacktype;
	if(\Pimcore\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("Snacktype")->isEmpty($data)) {
		try {
			return $this->getValueFromParent("Snacktype");
		} catch (InheritanceParentNotFoundException $e) {
			// no data from parent available, continue ...
		}
	}
...
/**
* Set Snacktype - SnackType
* @param string|null $Snacktype
* @return \Pimcore\Model\DataObject\Objectbrick\Data\Namkeen
*/
public function setSnacktype (?string $Snacktype)
{
