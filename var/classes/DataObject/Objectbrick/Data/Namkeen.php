...
class Namkeen extends DataObject\Objectbrick\Data\AbstractData
{
protected $type = "Namkeen";
protected $ItemId;
protected $Name;
protected $tasteType;
protected $NamkeenType;
protected $Flavour;
protected $Weight;
...
* @return \Pimcore\Model\DataObject\Objectbrick\Data\Namkeen
*/
...
/**
* Get NamkeenType - NamkeenType
* @return string|null
*/
public function getNamkeenType(): ?string
{
	$data = $this->NamkeenType;
	if(\Pimcore\Model\DataObject::doGetInheritedValues($this->getObject()) && $this->getDefinition()->getFieldDefinition("NamkeenType")->isEmpty($data)) {
		try {
			return $this->getValueFromParent("NamkeenType");
		} catch (InheritanceParentNotFoundException $e) {
			// no data from parent available, continue ...
		}
	}
...
/**
* Set NamkeenType - NamkeenType
* @param string|null $NamkeenType
* @return \Pimcore\Model\DataObject\Objectbrick\Data\Namkeen
*/
public function setNamkeenType (?string $NamkeenType)
{
	$this->NamkeenType = $NamkeenType;
