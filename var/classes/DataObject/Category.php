...
public function getCategoryType(): ?string
{
	...
	if (\Pimcore\Model\DataObject::doGetInheritedValues() && $this->getClass()->getFieldDefinition("CategoryType")->isEmpty($data)) {
		try {
			return $this->getValueFromParent("CategoryType");
