 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeLastnameService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_lastname'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_lastname'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_lastname'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Input($a);
    }
}
