 ...
 */
class getPimcore_Datahub_Graphql_DataobjectmutationtypegeneratorDatatypeSliderService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_slider'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_slider'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_slider'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectMutationFieldConfigGenerator\Numeric($a);
    }
}
