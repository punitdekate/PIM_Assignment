 ...
 */
class getPimcore_Datahub_Graphql_DocumentelementquerytypegeneratorDatatypeTableService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_table'])) {
            return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_table'];
        }

        return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_table'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DocumentElementQueryFieldConfigGenerator\Table($a);
    }
}
