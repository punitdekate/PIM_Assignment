 ...
 */
class getPimcore_Datahub_Graphql_Dataobjectqueryoperator_Factory_SubstringService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectqueryoperator.factory.substring'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectqueryoperator.factory.substring'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectqueryoperator.factory.substring'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\Query\Operator\Factory\DefaultQueryOperatorFactory($a, 'Pimcore\\Bundle\\DataHubBundle\\GraphQL\\Query\\Operator\\Substring');
    }
}
