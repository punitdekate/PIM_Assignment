 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeHotspotimageService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_hotspotimage'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_hotspotimage'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_hotspotimage'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Hotspotimage($a);
    }
}
