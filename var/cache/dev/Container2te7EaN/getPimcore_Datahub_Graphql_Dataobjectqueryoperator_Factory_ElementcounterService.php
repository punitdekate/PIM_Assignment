 ...
 */
class getPimcore_Datahub_Graphql_Dataobjectqueryoperator_Factory_ElementcounterService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectqueryoperator.factory.elementcounter'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectqueryoperator.factory.elementcounter'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectqueryoperator.factory.elementcounter'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\Query\Operator\Factory\DefaultQueryOperatorFactory($a, 'Pimcore\\Bundle\\DataHubBundle\\GraphQL\\Query\\Operator\\ElementCounter');
    }
}
