...
class getTwoFactorListenerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['Pimcore\\Bundle\\AdminBundle\\EventListener\\TwoFactorListener'])) {
            return $container->privates['Pimcore\\Bundle\\AdminBundle\\EventListener\\TwoFactorListener'];
        }

        $container->privates['Pimcore\\Bundle\\AdminBundle\\EventListener\\TwoFactorListener'] = $instance = new \Pimcore\Bundle\AdminBundle\EventListener\TwoFactorListener($a, ($container->privates['scheb_two_factor.provider_preparation_recorder'] ?? $container->getSchebTwoFactor_ProviderPreparationRecorderService()));
