 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeTextareaService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_textarea'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_textarea'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_textarea'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Base($a);
    }
}
