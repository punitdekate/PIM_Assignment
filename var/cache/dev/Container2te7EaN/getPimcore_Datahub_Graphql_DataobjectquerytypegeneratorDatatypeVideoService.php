 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeVideoService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_video'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_video'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_video'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Video($a);
    }
}
