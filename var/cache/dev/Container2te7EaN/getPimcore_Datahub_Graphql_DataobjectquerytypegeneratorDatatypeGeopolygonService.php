 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeGeopolygonService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geopolygon'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geopolygon'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geopolygon'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Geopolygon($a);
    }
}
