 ...
 */
class getPimcore_Datahub_Graphql_DocumentelementquerytypegeneratorDatatypeSelectService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_select'])) {
            return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_select'];
        }

        return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_select'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DocumentElementQueryFieldConfigGenerator\Select($a);
    }
}
