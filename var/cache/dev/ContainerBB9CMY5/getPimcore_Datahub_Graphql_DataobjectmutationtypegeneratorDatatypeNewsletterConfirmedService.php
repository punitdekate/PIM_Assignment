 ...
 */
class getPimcore_Datahub_Graphql_DataobjectmutationtypegeneratorDatatypeNewsletterConfirmedService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_newsletterConfirmed'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_newsletterConfirmed'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_newsletterConfirmed'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectMutationFieldConfigGenerator\Checkbox($a);
    }
}
