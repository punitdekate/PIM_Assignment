 ...
 */
class getPimcore_Datahub_Graphql_DataobjectmutationtypegeneratorOperatorIfemptyService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_operator_ifempty'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_operator_ifempty'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_operator_ifempty'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectMutationOperatorConfigGenerator\IfEmpty($a);
    }
}
