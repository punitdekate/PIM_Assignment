...
class getHardlinkControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Pimcore\\Bundle\\AdminBundle\\Controller\\Admin\\Document\\HardlinkController'] = $instance = new \Pimcore\Bundle\AdminBundle\Controller\Admin\Document\HardlinkController();

        $instance->setContainer(($container->privates['.service_locator.oafe0zm'] ?? $container->load('get_ServiceLocator_Oafe0zmService'))->withContext('Pimcore\\Bundle\\AdminBundle\\Controller\\Admin\\Document\\HardlinkController', $container));
