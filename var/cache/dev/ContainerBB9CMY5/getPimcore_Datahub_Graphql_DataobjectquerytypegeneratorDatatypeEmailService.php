 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeEmailService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_email'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_email'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_email'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Input($a);
    }
}
