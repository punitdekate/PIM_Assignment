 ...
 */
class getPimcore_Datahub_Graphql_Generaltype_Factory_AssetService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.generaltype.factory.asset'])) {
            return $container->privates['pimcore.datahub.graphql.generaltype.factory.asset'];
        }

        return $container->privates['pimcore.datahub.graphql.generaltype.factory.asset'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\GeneralTypeFactory($a, 'Pimcore\\Bundle\\DataHubBundle\\GraphQL\\AssetType\\AssetType');
    }
}
