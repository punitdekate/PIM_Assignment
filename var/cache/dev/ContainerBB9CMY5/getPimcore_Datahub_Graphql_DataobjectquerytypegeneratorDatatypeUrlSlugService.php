 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeUrlSlugService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_urlSlug'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_urlSlug'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_urlSlug'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\UrlSlug($a);
    }
}
