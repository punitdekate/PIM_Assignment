 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeHrefService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_href'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_href'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_href'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Href($a);
    }
}
