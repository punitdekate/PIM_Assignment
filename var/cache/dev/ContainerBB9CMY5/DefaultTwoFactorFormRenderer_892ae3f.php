...
class DefaultTwoFactorFormRenderer_892ae3f extends \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\DefaultTwoFactorFormRenderer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializeref79f && ($this->initializeref79f->__invoke($valueHolder839a3, $this, 'renderForm', array('request' => $request, 'templateVars' => $templateVars), $this->initializeref79f) || 1) && $this->valueHolder839a3 = $valueHolder839a3;

        return $this->valueHolder839a3->renderForm($request, $templateVars);
    }
    ...
    public function __construct(\Twig\Environment $twigRenderer, string $template, array $templateVars = [])
    {
        ...
        $this->valueHolder839a3->__construct($twigRenderer, $template, $templateVars);
    }
