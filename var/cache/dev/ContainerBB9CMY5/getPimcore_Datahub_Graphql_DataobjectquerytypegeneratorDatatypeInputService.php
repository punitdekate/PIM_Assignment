 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeInputService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_input'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_input'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_input'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Input($a);
    }
}
