...
class getLoginControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Pimcore\\Bundle\\AdminBundle\\Controller\\Admin\\LoginController'] = $instance = new \Pimcore\Bundle\AdminBundle\Controller\Admin\LoginController(($container->services['Pimcore\\Http\\ResponseHelper'] ?? ($container->services['Pimcore\\Http\\ResponseHelper'] = new \Pimcore\Http\ResponseHelper())));

        $instance->setContainer(($container->privates['.service_locator.oafe0zm'] ?? $container->load('get_ServiceLocator_Oafe0zmService'))->withContext('Pimcore\\Bundle\\AdminBundle\\Controller\\Admin\\LoginController', $container));
