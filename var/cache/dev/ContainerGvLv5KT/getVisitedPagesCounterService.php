...
class getVisitedPagesCounterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['Pimcore\\Targeting\\Service\\VisitedPagesCounter'] ?? $container->load('getVisitedPagesCounter2Service'));

        if (isset($container->privates['Pimcore\\Targeting\\DataProvider\\VisitedPagesCounter'])) {
            return $container->privates['Pimcore\\Targeting\\DataProvider\\VisitedPagesCounter'];
        }

        return $container->privates['Pimcore\\Targeting\\DataProvider\\VisitedPagesCounter'] = new \Pimcore\Targeting\DataProvider\VisitedPagesCounter($a);
    }
}
