...
class getTargetingStorageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['Pimcore\\Targeting\\DataProvider\\TargetingStorage'])) {
            return $container->privates['Pimcore\\Targeting\\DataProvider\\TargetingStorage'];
        }

        return $container->privates['Pimcore\\Targeting\\DataProvider\\TargetingStorage'] = new \Pimcore\Targeting\DataProvider\TargetingStorage($a);
    }
}
