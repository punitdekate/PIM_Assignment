...
class getApplicationLoggerDbService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['Pimcore\\Log\\Handler\\ApplicationLoggerDb'])) {
            return $container->services['Pimcore\\Log\\Handler\\ApplicationLoggerDb'];
        }

        $container->services['Pimcore\\Log\\Handler\\ApplicationLoggerDb'] = $instance = new \Pimcore\Log\Handler\ApplicationLoggerDb($a);
