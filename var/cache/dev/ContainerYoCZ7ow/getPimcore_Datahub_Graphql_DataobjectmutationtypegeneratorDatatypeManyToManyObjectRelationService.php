 ...
 */
class getPimcore_Datahub_Graphql_DataobjectmutationtypegeneratorDatatypeManyToManyObjectRelationService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_manyToManyObjectRelation'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_manyToManyObjectRelation'];
        }
        ...
        return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_manyToManyObjectRelation'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectMutationFieldConfigGenerator\ManyToManyObjectRelation($a, $b);
    }
}
