 ...
 */
class getPimcore_Datahub_Graphql_Generaltype_Factory_ElementTagService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.generaltype.factory.element_tag'])) {
            return $container->privates['pimcore.datahub.graphql.generaltype.factory.element_tag'];
        }

        return $container->privates['pimcore.datahub.graphql.generaltype.factory.element_tag'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\GeneralTypeFactory($a, 'Pimcore\\Bundle\\DataHubBundle\\GraphQL\\ElementTag');
    }
}
