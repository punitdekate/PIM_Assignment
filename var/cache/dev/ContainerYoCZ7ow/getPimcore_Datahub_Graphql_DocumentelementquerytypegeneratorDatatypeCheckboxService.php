 ...
 */
class getPimcore_Datahub_Graphql_DocumentelementquerytypegeneratorDatatypeCheckboxService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_checkbox'])) {
            return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_checkbox'];
        }

        return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_checkbox'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DocumentElementQueryFieldConfigGenerator\Checkbox($a);
    }
}
