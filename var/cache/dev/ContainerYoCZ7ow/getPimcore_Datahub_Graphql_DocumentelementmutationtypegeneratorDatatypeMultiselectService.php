 ...
 */
class getPimcore_Datahub_Graphql_DocumentelementmutationtypegeneratorDatatypeMultiselectService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.documentelementmutationtypegenerator_datatype_multiselect'])) {
            return $container->privates['pimcore.datahub.graphql.documentelementmutationtypegenerator_datatype_multiselect'];
        }

        return $container->privates['pimcore.datahub.graphql.documentelementmutationtypegenerator_datatype_multiselect'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DocumentElementMutationFieldConfigGenerator\Multiselect($a, new \Pimcore\Bundle\DataHubBundle\GraphQL\DocumentElementInputProcessor\Multiselect(($container->services['Pimcore\\Model\\Document\\Editable\\Loader\\EditableLoader'] ?? $container->getEditableLoaderService()), $a));
    }
}
