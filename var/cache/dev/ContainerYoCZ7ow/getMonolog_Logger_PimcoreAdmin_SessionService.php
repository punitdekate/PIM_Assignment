 ...
 */
class getMonolog_Logger_PimcoreAdmin_SessionService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->services['monolog.logger.pimcore_admin.session'] = $instance = new \Symfony\Bridge\Monolog\Logger('pimcore_admin.session');
