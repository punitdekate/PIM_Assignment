...
class getCacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 8 => ($container->privates['Pimcore\\HttpKernel\\CacheWarmer\\MkdirCacheWarmer'] ?? ($container->privates['Pimcore\\HttpKernel\\CacheWarmer\\MkdirCacheWarmer'] = new \Pimcore\HttpKernel\CacheWarmer\MkdirCacheWarmer()));
            yield 9 => ($container->privates['Pimcore\\HttpKernel\\CacheWarmer\\PimcoreCoreCacheWarmer'] ?? ($container->privates['Pimcore\\HttpKernel\\CacheWarmer\\PimcoreCoreCacheWarmer'] = new \Pimcore\HttpKernel\CacheWarmer\PimcoreCoreCacheWarmer()));
