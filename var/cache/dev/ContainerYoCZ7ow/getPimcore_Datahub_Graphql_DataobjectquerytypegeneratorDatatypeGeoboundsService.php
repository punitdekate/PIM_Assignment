 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeGeoboundsService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geobounds'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geobounds'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geobounds'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Geobounds($a);
    }
}
