 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeInputquantityvalueService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_inputquantityvalue'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_inputquantityvalue'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_inputquantityvalue'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\InputQuantityValue($a);
    }
}
