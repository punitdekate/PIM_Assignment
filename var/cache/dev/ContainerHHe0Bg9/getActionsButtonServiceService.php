...
class getActionsButtonServiceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['Pimcore\\Workflow\\ActionsButtonService'])) {
            return $container->privates['Pimcore\\Workflow\\ActionsButtonService'];
        }

        return $container->privates['Pimcore\\Workflow\\ActionsButtonService'] = new \Pimcore\Workflow\ActionsButtonService($a);
    }
}
