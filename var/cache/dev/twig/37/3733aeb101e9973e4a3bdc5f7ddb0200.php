...
class __TwigTemplate_71d0a0fe844a55e2b2d1bf6bd77f9eed extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"log-metadata\">
        ...
        ";
            ...
            if ((isset($context["has_context"]) || array_key_exists("has_context", $context) ? $context["has_context"] : (function () { throw new RuntimeError('Variable "has_context" does not exist.', 258, $this->source); })())) {
                // line 259
                echo "            <div id=\"";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["context_id"]) || array_key_exists("context_id", $context) ? $context["context_id"] : (function () { throw new RuntimeError('Variable "context_id" does not exist.', 259, $this->source); })()), 259, $this->source), "html", null, true);
                echo "\" class=\"context sf-toggle-content sf-toggle-hidden\">
                ";
                // line 260
                echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 260, $this->source); })()), "context", [], "any", false, false, true, 260), 260, $this->source), 1);
                echo "
            </div>
        ";
            }
        ...
        ";
            ...
            if ((isset($context["has_trace"]) || array_key_exists("has_trace", $context) ? $context["has_trace"] : (function () { throw new RuntimeError('Variable "has_trace" does not exist.', 264, $this->source); })())) {
                // line 265
                echo "            <div id=\"";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["trace_id"]) || array_key_exists("trace_id", $context) ? $context["trace_id"] : (function () { throw new RuntimeError('Variable "trace_id" does not exist.', 265, $this->source); })()), 265, $this->source), "html", null, true);
                echo "\" class=\"context sf-toggle-content sf-toggle-hidden\">
                ";
                // line 266
                echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 266, $this->source); })()), "context", [], "any", false, false, true, 266), "exception", [], "any", false, false, true, 266), "trace", [], "any", false, false, true, 266), 266, $this->source), 1);
                echo "
            </div>
        ";
            }
...
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/var/www/html/firstproject/GroceryStore/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("include" => 9, "profiler_dump_log" => 216, "profiler_dump" => 260);
