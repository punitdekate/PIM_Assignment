...
class __TwigTemplate_87d8df50b07eb3b67db10a20763a289b extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body class=\"pimcore_version_10 ";
        ...
        // line 22
        echo "        ";
        if (twig_matches("@^https?://@", (isset($context["customImage"]) || array_key_exists("customImage", $context) ? $context["customImage"] : (function () { throw new RuntimeError('Variable "customImage" does not exist.', 22, $this->source); })()))) {
            // line 23
            echo "            ";
...
", "@PimcoreAdmin/Admin/Login/layout.html.twig", "/var/www/html/firstproject/GroceryStore/vendor/pimcore/pimcore/bundles/AdminBundle/Resources/views/Admin/Login/layout.html.twig");
    }
