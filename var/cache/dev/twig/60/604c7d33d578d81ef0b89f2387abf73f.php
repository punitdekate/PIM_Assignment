...
class __TwigTemplate_3d1998d9b8e5b71c3ff12576f38fb905 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"page\" id=\"documentpage-";
        // line 4
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["document"]) || array_key_exists("document", $context) ? $context["document"] : (function () { throw new RuntimeError('Variable "document" does not exist.', 4, $this->source); })()), "id", [], "any", false, false, true, 4), 4, $this->source), "html", null, true);
        echo "\">
...
{% endblock %}
", "web2print/default_no_layout.html.twig", "/var/www/html/firstproject/GroceryStore/templates/web2print/default_no_layout.html.twig");
    }
