...
class __TwigTemplate_b813b6a181f4a0f87c3889f71f9f8329 extends Template
{
    private $source;
    private $macros = [];
...
body {
    ...
    ";
        // line 26
        echo $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["mixins"]) || array_key_exists("mixins", $context) ? $context["mixins"] : (function () { throw new RuntimeError('Variable "mixins" does not exist.', 26, $this->source); })()), "sans_serif_font", [], "any", false, false, true, 26), 26, $this->source);
        echo "
    font-size: 14px;
    line-height: 1.4;
}
...
";
    ...
    {
        return array (  65 => 26,  54 => 17,  50 => 13,  47 => 9,  45 => 3,);
    }
...
", "@WebProfiler/Profiler/open.css.twig", "/var/www/html/firstproject/GroceryStore/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/open.css.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 3);
        static $filters = array("raw" => 26);
