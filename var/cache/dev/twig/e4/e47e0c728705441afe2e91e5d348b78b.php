...
class __TwigTemplate_f385aaedfe907e340e71bc9d7fc19dea extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 8
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["location"]) || array_key_exists("location", $context) ? $context["location"] : (function () { throw new RuntimeError('Variable "location" does not exist.', 8, $this->source); })()), 8, $this->source), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["location"]) || array_key_exists("location", $context) ? $context["location"] : (function () { throw new RuntimeError('Variable "location" does not exist.', 8, $this->source); })()), 8, $this->source), "html", null, true);
        echo "</a>.</h1>
...
";
    ...
    {
        return array (  94 => 8,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Profiler/toolbar_redirect.html.twig", "/var/www/html/firstproject/GroceryStore/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/toolbar_redirect.html.twig");
    }
