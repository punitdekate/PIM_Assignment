...
class __TwigTemplate_f501650fef8d453a72df890e48b091d0 extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    ...
    {% include '@PimcoreAdmin/SearchAdmin/Search/Quicksearch/info-table.html.twig' with {'element': element} %}
{% endif %}
", "@PimcoreAdmin/SearchAdmin/Search/Quicksearch/document.html.twig", "/var/www/html/grocery/vendor/pimcore/pimcore/bundles/AdminBundle/Resources/views/SearchAdmin/Search/Quicksearch/document.html.twig");
    }
