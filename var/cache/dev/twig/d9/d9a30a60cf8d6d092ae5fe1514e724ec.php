...
class __TwigTemplate_f0510486c5a4f967a6ff4e226be28c25 extends Template
{
    private $source;
    private $macros = [];
    ...
    <tbody>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["bag"]) || array_key_exists("bag", $context) ? $context["bag"] : (function () { throw new RuntimeError('Variable "bag" does not exist.', 9, $this->source); })()), "keys", [], "any", false, false, true, 9)));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
            ...
            echo "</th>
                <td>";
            // line 12
            echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["bag"]) || array_key_exists("bag", $context) ? $context["bag"] : (function () { throw new RuntimeError('Variable "bag" does not exist.', 12, $this->source); })()), "get", [0 => $context["key"]], "method", false, false, true, 12), 12, $this->source), ((array_key_exists("maxDepth", $context)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed((isset($context["maxDepth"]) || array_key_exists("maxDepth", $context) ? $context["maxDepth"] : (function () { throw new RuntimeError('Variable "maxDepth" does not exist.', 12, $this->source); })()), 12, $this->source), 0)) : (0)));
            echo "</td>
            </tr>
        ";
...
", "@WebProfiler/Profiler/bag.html.twig", "/var/www/html/firstproject/GroceryStore/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/bag.html.twig");
    }
