 ...
 */
class getPimcore_ApplicationLog_StorageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'pimcore.application_log.storage' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['pimcore.application_log.storage'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Local\LocalFilesystemAdapter((\dirname(__DIR__, 3).'/application-logger'), \League\Flysystem\UnixVisibility\PortableVisibilityConverter::fromArray(['file' => ['public' => 420, 'private' => 384], 'dir' => ['public' => 493, 'private' => 448]]), 0, 2, NULL, false), ['visibility' => 'private', 'directory_visibility' => NULL, 'case_sensitive' => true, 'disable_asserts' => false]);
    }
}
