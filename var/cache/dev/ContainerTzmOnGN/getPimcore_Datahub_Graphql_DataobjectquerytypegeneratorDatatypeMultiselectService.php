 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeMultiselectService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multiselect'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multiselect'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multiselect'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Multiselect($a);
    }
}
