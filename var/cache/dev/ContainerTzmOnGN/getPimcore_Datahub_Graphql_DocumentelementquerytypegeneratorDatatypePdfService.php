 ...
 */
class getPimcore_Datahub_Graphql_DocumentelementquerytypegeneratorDatatypePdfService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_pdf'])) {
            return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_pdf'];
        }

        return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_pdf'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DocumentElementQueryFieldConfigGenerator\Pdf($a);
    }
}
