 ...
 */
class getPimcore_Datahub_Graphql_Generaltype_Factory_VideoService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.generaltype.factory.video'])) {
            return $container->privates['pimcore.datahub.graphql.generaltype.factory.video'];
        }

        return $container->privates['pimcore.datahub.graphql.generaltype.factory.video'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\GeneralTypeFactory($a, 'Pimcore\\Bundle\\DataHubBundle\\GraphQL\\DataObjectType\\VideoType');
    }
}
