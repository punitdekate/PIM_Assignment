 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeObjectsService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_objects'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_objects'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_objects'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Objects($a);
    }
}
