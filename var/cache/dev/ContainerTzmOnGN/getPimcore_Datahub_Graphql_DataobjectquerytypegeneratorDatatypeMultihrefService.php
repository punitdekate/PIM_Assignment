 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeMultihrefService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multihref'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multihref'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multihref'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Multihref($a);
    }
}
