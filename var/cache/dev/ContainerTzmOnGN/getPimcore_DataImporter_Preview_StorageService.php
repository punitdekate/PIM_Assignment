 ...
 */
class getPimcore_DataImporter_Preview_StorageService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['pimcore.dataImporter.preview.storage'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Local\LocalFilesystemAdapter((\dirname(__DIR__, 3).'/tmp/datahub/dataimporter/preview'), \League\Flysystem\UnixVisibility\PortableVisibilityConverter::fromArray(['file' => ['public' => 420, 'private' => 384], 'dir' => ['public' => 493, 'private' => 448]]), 0, 2, NULL, false), ['visibility' => 'private', 'directory_visibility' => NULL, 'case_sensitive' => true, 'disable_asserts' => false]);
    }
}
