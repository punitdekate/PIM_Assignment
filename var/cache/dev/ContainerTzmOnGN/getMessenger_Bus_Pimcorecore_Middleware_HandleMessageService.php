...
class getMessenger_Bus_Pimcorecore_Middleware_HandleMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1), 'Pimcore\\Bundle\\DataImporterBundle\\Messenger\\DataImporterMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.SuHHznQ'] ?? $container->load('get_Messenger_HandlerDescriptor_SuHHznQService'));
        }, 1)]));
