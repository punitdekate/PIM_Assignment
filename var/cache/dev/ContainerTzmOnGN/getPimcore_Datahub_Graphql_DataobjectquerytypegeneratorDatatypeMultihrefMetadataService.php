 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeMultihrefMetadataService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multihrefMetadata'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multihrefMetadata'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_multihrefMetadata'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\MultihrefMetadata($a);
    }
}
