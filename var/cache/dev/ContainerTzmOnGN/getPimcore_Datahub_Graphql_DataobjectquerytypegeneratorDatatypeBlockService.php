 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeBlockService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_block'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_block'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_block'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Block($a);
    }
}
