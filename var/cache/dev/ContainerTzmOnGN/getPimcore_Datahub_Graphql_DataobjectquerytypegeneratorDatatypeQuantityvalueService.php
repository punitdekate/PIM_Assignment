 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeQuantityvalueService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_quantityvalue'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_quantityvalue'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_quantityvalue'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\QuantityValue($a);
    }
}
