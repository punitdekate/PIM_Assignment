 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeCalculatedvalueService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_calculatedvalue'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_calculatedvalue'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_calculatedvalue'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\CalculatedValue($a);
    }
}
