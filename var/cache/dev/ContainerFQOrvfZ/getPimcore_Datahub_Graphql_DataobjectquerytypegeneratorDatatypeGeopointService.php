 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeGeopointService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geopoint'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geopoint'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_geopoint'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Geopoint($a);
    }
}
