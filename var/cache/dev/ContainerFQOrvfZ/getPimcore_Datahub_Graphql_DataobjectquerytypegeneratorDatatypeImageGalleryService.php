...
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeImageGalleryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_imageGallery'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_imageGallery'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_imageGallery'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\ImageGallery($a);
    }
}
