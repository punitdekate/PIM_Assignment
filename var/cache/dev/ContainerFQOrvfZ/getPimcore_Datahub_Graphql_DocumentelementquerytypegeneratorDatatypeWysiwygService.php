 ...
 */
class getPimcore_Datahub_Graphql_DocumentelementquerytypegeneratorDatatypeWysiwygService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_wysiwyg'])) {
            return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_wysiwyg'];
        }

        return $container->privates['pimcore.datahub.graphql.documentelementquerytypegenerator_datatype_wysiwyg'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DocumentElementQueryFieldConfigGenerator\Wysiwyg($a);
    }
}
