...
class getMessenger_Transport_PimcoreDataImportService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.pimcore_data_import'] = $a->createTransport('doctrine://default?queue_name=pimcore_data_import', ['transport_name' => 'pimcore_data_import'], ($container->privates['messenger.transport.native_php_serializer'] ?? ($container->privates['messenger.transport.native_php_serializer'] = new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer())));
    }
}
