...
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeClassificationstoreService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_classificationstore'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_classificationstore'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_classificationstore'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Classificationstore($a);
    }
}
