 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeDateService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_date'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_date'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_date'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Base($a);
    }
}
