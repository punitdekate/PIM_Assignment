 ...
 */
class getPimcore_Datahub_Graphql_DataobjectquerytypegeneratorDatatypeDatetimeService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_datetime'])) {
            return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_datetime'];
        }

        return $container->privates['pimcore.datahub.graphql.dataobjectquerytypegenerator_datatype_datetime'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Datetime($a);
    }
}
